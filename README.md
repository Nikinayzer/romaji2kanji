...
## ! UPDATE !
**This project is in ongoing migration to Client/Server architecture.** Here are new [branch](https://github.com/Nikinayzer/romaji2kanji/tree/backend-integration) and [server](https://github.com/Zemlovka/romaji-to-kanji-server)
